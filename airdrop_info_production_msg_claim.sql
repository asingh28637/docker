...
--
-- Table structure for table `msg_claim`
--

DROP TABLE IF EXISTS `msg_claim`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `msg_claim` (
  `msg_status` int NOT NULL,
  `msg_note` varchar(300) NOT NULL,
  PRIMARY KEY (`msg_status`)
...
-- Dump completed on 2025-08-21 10:22:45
