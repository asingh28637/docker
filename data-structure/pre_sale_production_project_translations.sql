...
CREATE TABLE `project_translations` (
  ...
  `translated_project_name` varchar(255) NOT NULL,
  ...
  CONSTRAINT `project_translations_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `projects` (`project_id`) ON DELETE CASCADE
...
-- Dump completed on 2025-10-10  9:17:37
