...
CREATE TABLE `bots` (
  ...
  `include_member_ids` json NOT NULL,
  `symbol` varchar(100) NOT NULL,
  `target_exchange` enum('bybit','mexc','xeggex','nonkyc') NOT NULL,
  `target_symbol` varchar(50) NOT NULL,
  `min_usd` decimal(32,16) NOT NULL,
  `max_usd` decimal(32,16) NOT NULL,
  `seconds_elapsed_from_now` int NOT NULL,
...
-- Dump completed on 2025-10-10  9:21:40
