...
--
-- Host: 185.100.233.95    Database: arbitrage_production
-- ------------------------------------------------------
...
CREATE TABLE `orders` (
  ...
  `origin_order_side` enum('buy','sell') NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `orders_access_id_index` (`access_id`),
  KEY `orders_bot_id_index` (`bot_id`),
  KEY `orders_origin_order_id_index` (`origin_order_id`),
  KEY `orders_origin_order_side_index` (`origin_order_side`),
  CONSTRAINT `orders_access_id_foreign` FOREIGN KEY (`access_id`) REFERENCES `accesses` (`id`) ON UPDATE CASCADE,
...
-- Dump completed on 2025-10-10  9:15:05
