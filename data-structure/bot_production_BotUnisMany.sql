...
--
-- Table structure for table `BotUnisMany`
--

DROP TABLE IF EXISTS `BotUnisMany`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `BotUnisMany` (
  ...
  `is_price_direct` tinyint(1) NOT NULL DEFAULT '0',
  ...
  `total_side_usd` float NOT NULL DEFAULT '0',
  `min_usd` float NOT NULL,
  `max_usd` float NOT NULL,
  `percent_random_create_volume` float NOT NULL DEFAULT '80',
  `ratio_stop_distance` float NOT NULL DEFAULT '10',
  `volume_min_usd` float NOT NULL DEFAULT '5',
  `volume_max_usd` float NOT NULL DEFAULT '10',
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  PRIMARY KEY (`id_bot`),
  KEY `BotUnisMany_id_host_idx` (`id_host`),
  CONSTRAINT `BotUnisMany_id_host_fkey` FOREIGN KEY (`id_host`) REFERENCES `HostApi` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
-- Dump completed on 2025-10-10  9:13:22
