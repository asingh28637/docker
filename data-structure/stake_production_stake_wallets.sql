...
--
-- Table structure for table `stake_wallets`
--

DROP TABLE IF EXISTS `stake_wallets`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `stake_wallets` (
  ...
  PRIMARY KEY (`member_id`,`currency_id`),
  KEY `idx_member_currency` (`member_id`,`currency_id`),
  KEY `idx_uid_currency` (`uid`,`currency_id`)
...
-- Dump completed on 2025-10-10  9:15:17
