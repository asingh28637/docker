...
CREATE TABLE `project_statistics` (
  ...
  `total_invested` decimal(34,18) NOT NULL DEFAULT '0.000000000000000000',
  `remaining_tokens` decimal(34,18) NOT NULL,
  PRIMARY KEY (`project_id`),
  KEY `project_id` (`project_id`),
  CONSTRAINT `project_statistics_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `projects` (`project_id`) ON DELETE CASCADE
...
-- Dump completed on 2025-10-10  9:17:53
