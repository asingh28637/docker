...
--
-- Table structure for table `BotVolume`
--

DROP TABLE IF EXISTS `BotVolume`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `BotVolume` (
  ...
  `secret_key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id_bot`),
  KEY `BotVolume_id_host_idx` (`id_host`),
  CONSTRAINT `BotVolume_id_host_fkey` FOREIGN KEY (`id_host`) REFERENCES `HostApi` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
-- Dump completed on 2025-10-10  9:13:26
