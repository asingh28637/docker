...
CREATE TABLE `host_history` (
  ...
  `obalance` decimal(34,18) DEFAULT NULL,
  `nbalance` decimal(34,18) DEFAULT NULL,
  `olocked` decimal(34,18) DEFAULT NULL,
  `nlocked` decimal(34,18) DEFAULT NULL,
...
-- Dump completed on 2025-10-10  9:18:43
