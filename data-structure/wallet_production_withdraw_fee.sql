...
--
-- Table structure for table `withdraw_fee`
--

DROP TABLE IF EXISTS `withdraw_fee`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `withdraw_fee` (
  `id` int NOT NULL AUTO_INCREMENT,
  `currency_id` varchar(20) NOT NULL,
  `fee_amount` decimal(34,18) NOT NULL DEFAULT '0.000000000000000000',
  `fee_currency` varchar(20) NOT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_currency_fee` (`currency_id`,`fee_currency`)
...
-- Dump completed on 2025-10-10  9:20:21
