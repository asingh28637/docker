...
--
-- Table structure for table `trash_distribution`
--

DROP TABLE IF EXISTS `trash_distribution`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `trash_distribution` (
  ...
  PRIMARY KEY (`id`),
  KEY `trash_distribution_connection_id_idx` (`connection_id`),
  CONSTRAINT `fk_trash_distribution_connection` FOREIGN KEY (`connection_id`) REFERENCES `connections` (`connection_id`)
...
-- Dump completed on 2025-10-10  9:12:53
