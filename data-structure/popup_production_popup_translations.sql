...
CREATE TABLE `popup_translations` (
  ...
  `language` enum('en','ko','zh') NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_popup_language` (`popup_id`,`language`),
  CONSTRAINT `popup_translations_ibfk_1` FOREIGN KEY (`popup_id`) REFERENCES `popup_list` (`popup_id`) ON DELETE CASCADE
...
-- Dump completed on 2025-10-10  9:21:36
