...
--
-- Host: 185.100.233.95    Database: email_production
-- ------------------------------------------------------
...
DROP TABLE IF EXISTS `email_sent_logs`;
...
CREATE TABLE `email_sent_logs` (
  ...
  CONSTRAINT `fk_sent_log_job` FOREIGN KEY (`job_id`) REFERENCES `email_jobs` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-10-10  9:17:20
